...
AURELIA_FINCH_PACKAGE_PATH = DEFINITIONS_DIR / "aurelia_finch_character_package.json"
...
def load_character_package(path: Path = WIZARD_JOE_PACKAGE_PATH) -> CharacterPackage:
    ...
    if optional_assets["extraction_audit"] is not None:
        ...
        _validate_direct_cell_manifest(
            raw, package_path, pose_raw, pixel_graph_raw, audit_raw,
            manifest_raw, optional_assets,
        )
