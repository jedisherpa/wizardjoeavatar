...
class WizardState:
    ...
    animation_transition_phase: str = "stable"
    animation_transition_target_node_id: Optional[str] = None
    animation_transition_target_clip_id: Optional[str] = None
    animation_transition_entry_tick: int = 0
    animation_transition_started_tick: int = 0
    animation_transition_commit_tick: int = 0
