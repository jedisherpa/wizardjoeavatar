...
def main() -> int:
    ...
    isolated_path = evidence_dir / "serena-quill-124-isolated-silhouettes.png"
    projected_path = evidence_dir / "serena-quill-124-pixel-graph-renders.png"
    ...
    summary_path = evidence_dir / "serena-quill-124-visual-audit.json"
