# Castle Grace front terraces — visualizer scene branch

**Branch:** `codex/joeville-scene-castle-front-terraces`  
**Scene ID:** `JV-CAS-FRONT-TERRACES`  
**Set ID:** `JV-CAS`  
**Source status:** `CANONICAL-CONCEPT-CLEAN-PLATE`

## Authority and source

The branch contains one scenic source at `assets/environments/joeville/jv-cas-front-terraces/source-reference.png`.

- Source dimensions: 1536×1024
- SHA-256: `e539cbc718aae5eeb404641a16e42d1172faf6999cd7b93f5a5471e71fbf5760`
- Production role: Castle exterior master, arrival, balcony dialogue and stair transitions
- Camera: Downslope three-quarter exterior master looking across stepped terraces
...
6. Add a scene registry entry keyed by `JV-CAS-FRONT-TERRACES` and a deterministic loader with checksum validation.
...
2. `castle_far_mass`
3. `upper_terrace`
4. `character_planes_three_depths`
5. `rail_occlusion`
6. `foreground_stairs`
7. `foliage`
8. `lighting`
...
Right stair is primary vertical entrance; upper and middle terraces are separate depth bands; garage landing is lower exit; rails require occlusion masks.
...
- Recompose production master to 16:9 if required
- Author rail and foliage alpha masks
- Validate each terrace ground line separately
...
- `wizard_avatar/definitions/environments/jv-cas-front-terraces.json`
- `assets/environments/joeville/jv-cas-front-terraces/master/`
- `assets/environments/joeville/jv-cas-front-terraces/layers/`
- `tests/wizard/test_environment_castle_front_terraces.py`
