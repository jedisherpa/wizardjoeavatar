...
| 36 | Automated tests pass. | **Implemented+verified** | Current Python discovery contains 444 tests, including eight soak-harness V2 measurement/PID/retention tests; the final rerun is recorded in `PRODUCTION_VERIFICATION.md`. Prior green gates remain: Python production scope (135 paths, zero violations), Companion frontend (27/27), Companion Rust (17/17), strict animation quality (32/32), Prism frontend (40/40), Prism build, locked release build, and Rust workspace tests. |
...
4. **Long-duration acceptance remains incomplete.** The strict staged V2 run
